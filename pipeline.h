...
public:
    ...
    /// @param min_z, max_z Bornes Z de la grille (mètres).
    /// @param step_z Pas en Z (mètres).
    ...
    GridPositionLayoutAugmentation(std::string object_name, 
                                    ...
                                    double min_z = 0.0, double max_z = 0.0, double step_z = 0.0, 
...
private:
        ...
        double m_min_z, m_max_z, m_step_z;
